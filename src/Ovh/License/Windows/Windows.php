...
{
	private $domain = null;
	private static $WindowsClient = null;
	 ...
	 *
	 * @return null|WindowsClient
	 */
	private static function getClient()
	{
		if (!self::$WindowsClient instanceof WindowsClient){
			self::$WindowsClient=new WindowsClient();
		};
		return self::$WindowsClient;
	}
