...
{
	private $domain = null;
	private static $PleskClient = null;
	 ...
	 * Return Plesk client
	 *
	 * @return null|PleskClient
	 */
	private static function getClient()
	{
		if (!self::$PleskClient instanceof PleskClient){
			self::$PleskClient=new PleskClient();
		};
		return self::$PleskClient;
	}
